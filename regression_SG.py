...
anglex = savgol_filter(anglex, 9, 3)
angley = savgol_filter(angley, 9, 3)
headpox = savgol_filter(headpox, 9, 3)
headpoy = savgol_filter(headpoy, 9, 3)
headpoz = savgol_filter(headpoz, 9, 3)
headrox = savgol_filter(headrox, 9, 3)
headroy = savgol_filter(headroy, 9, 3)
headroz = savgol_filter(headroz, 9, 3)
...
for i in range(2, 6):
    ...
    print('RMSE of degree', i, ' is ', poly_reg_rmse)
