...
anglex = expoAvg(anglex)
angley = expoAvg(angley)
headpox = expoAvg(headpox)
headpoy = expoAvg(headpoy)
headpoz = expoAvg(headpoz)
headrox = expoAvg(headrox)
headroy = expoAvg(headroy)
headroz = expoAvg(headroz)
